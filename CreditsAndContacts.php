...
echo "<pre><font face ='arial'>
	...
	<p class='d-flex'>Thank you for using the Simple Protein Searcher. The code used to create this site is available <a href='https://github.com/B270934-2024/WebsiteAssignment'>here</a>. Thank you all to the good people on StackOverflow for providing help with the various coding issues I faced, and ELM for aiding the debugging process. Also thank you to Al Iverns and all of my coursemates for the help and motivation! Finally, thanks to everyone who created the EMBOSS tools that the site makes very liberal use of, and to NCBI for providing an excellent database to query! If you have any questions or suggestsions, I would love to hear them. You can contact me <a href='mailto:s2761220@ed.ac.uk>here!</a></p>
</pre>
        <a href='Default.php?search=all' class = 'btn btn-secondary d-flex'>Browse Default Results</a>
        <a href='HelpAndContext.php' class = 'btn btn-secondary d-flex'>Help and Context</a>";
